       ...
       $(document).on('click', '#detailData', function () {
        ...
        function getDetailPesanan(id) {
            $.get('/admin/pesanan/'+id, function (data) {
                ...
                $('#detail #dNamaPelanggan').val(data['get_user']['get_pelanggan']['nama']);
                ...
                $('#detail #dhargaSatuan').val(data['get_harga'] ? data['get_harga']['harga'] : '');
                $('#detail #dhargaLaminasi').val(data['get_harga'] ? data['get_harga']['get_produk']['biaya_laminasi'] : '');
                ...
                $('#detail #imgProduk').attr('href',data['get_pembayaran'] ? data['get_pembayaran']['url_gambar'] : '');
                $('#detail #imgProduk img').attr('src',data['get_pembayaran'] ? data['get_pembayaran']['url_gambar'] : '');
            })
        }
        ...
        function getBuatHarga(id) {
            $.get('/admin/pesanan/'+id, function (data) {
                ...
                $('#modalbuatharga #hNamaPelanggan').val(data['get_user']['get_pelanggan']['nama']);
                ...
                $('#modalbuatharga #imgProduk').attr('href',data['get_pembayaran'] ? data['get_pembayaran']['url_gambar'] : '');
                $('#modalbuatharga #imgProduk img').attr('src',data['get_pembayaran'] ? data['get_pembayaran']['url_gambar'] : '');
            })
        }
    </script>
